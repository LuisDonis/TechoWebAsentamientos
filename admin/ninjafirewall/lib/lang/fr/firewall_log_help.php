...
<p><img src="static/bullet_off.gif">&nbsp;<strong>LEVEL :</strong> sévérité des attaques (moyen, élevé ou critique), information (info, erreur, téléchargement) and mode débogage (DEBUG_ON).</p>
